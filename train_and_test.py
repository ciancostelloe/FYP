...
def main():
    ...
    for npaContour in npaContours:                             # for each contour
        ...
        if contourWithData.fltArea > 580:
            break
        # end if
    ...
    for contourWithData in validContoursWithData:            # for each contour
        ...
        retval, npaResults, neigh_resp, dists = kNearest.find_nearest(npaROIResized, k = 11)     # call KNN function find_nearest
